...
const updateController = async (req: Request, res: Response) => {
  ...
  const updatedResult = await copyMeService.updateOne(params.id, body);
...
const deleteController = async (req: Request, res: Response) => {
  ...
  const deletedResult = await copyMeService.deleteOne(params.id);
...
const getController = async (req: Request, res: Response) => {
  ...
  const result = await copyMeService.getOne(params.id);
...
const getAllController = async (req: Request, res: Response) => {
  ...
  const result = await copyMeService.getAll(query);
